...
colour = c("#E9D5CA", "#827397", "#4D4C7D","#E9D5CA", "#827397", "#4D4C7D") # MADLEEN (Meine Farben)
...
ggplot(plotdata, aes(names, value)) +
  ...
  labs( title = "not normalized", y = "-yLab", x = "x-Lab")
...
rm(i, k, s, restructure_func, Data.copy) # MADLEEN
```



```{r transpose matrix}
Ctrl = as.data.frame(t(Ctrl)) # MADLEEN 
RNase = as.data.frame(t(RNase)) #MADLEEN
```
