...
## T Test results of local maxima will be the 3rd criteria
...
```{r}
load("C:/Users/Archid Knighton/Documents/GitHub/HS_RBPs.RData")

load("C:/Users/Archid Knighton/Documents/GitHub/HS_non_RBPs.RData")
...
```
Our non-linear regression model is better than our linear regression model, but the R^2 value is still not that high. We want to try to perform multiple regression and see if the R^2 gets better.
