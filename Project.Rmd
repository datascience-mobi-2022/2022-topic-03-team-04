...
allmaxima_Ctrl_0.1 = data.frame(apply(tCtrl_Norm, 2, function(x){maximafunction(x,0.1)}), row.names = fractionnames)
allmaxima_Ctrl_0.2 = data.frame(apply(tCtrl_Norm, 2, function(x){maximafunction(x,0.2)}), row.names = fractionnames)
allmaxima_Ctrl_0.3 = data.frame(apply(tCtrl_Norm, 2, function(x){maximafunction(x,0.3)}), row.names = fractionnames)
allmaxima_Ctrl_0.4 = data.frame(apply(tCtrl_Norm, 2, function(x){maximafunction(x,0.4)}), row.names = fractionnames)
allmaxima_Ctrl_0.5 = data.frame(apply(tCtrl_Norm, 2, function(x){maximafunction(x,0.5)}), row.names = fractionnames)

allmaxima_RNase_0.1 = data.frame(apply(tRNase_Norm, 2, function(x){maximafunction(x,0.1)}), row.names = fractionnames)
allmaxima_RNase_0.2 = data.frame(apply(tRNase_Norm, 2, function(x){maximafunction(x,0.2)}), row.names = fractionnames)
allmaxima_RNase_0.3 = data.frame(apply(tRNase_Norm, 2, function(x){maximafunction(x,0.3)}), row.names = fractionnames)
allmaxima_RNase_0.4 = data.frame(apply(tRNase_Norm, 2, function(x){maximafunction(x,0.4)}), row.names = fractionnames)
allmaxima_RNase_0.5 = data.frame(apply(tRNase_Norm, 2, function(x){maximafunction(x,0.5)}), row.names = fractionnames)

# Data Frame with number of Maxima from each threshold
...
max_number_Ctrl_0.1 = apply(allmaxima_Ctrl_0.1, 2, maximanumber)
max_number_Ctrl_0.2 = apply(allmaxima_Ctrl_0.2, 2, maximanumber)
max_number_Ctrl_0.3 = apply(allmaxima_Ctrl_0.3, 2, maximanumber)
max_number_Ctrl_0.4 = apply(allmaxima_Ctrl_0.4, 2, maximanumber)
max_number_Ctrl_0.5 = apply(allmaxima_Ctrl_0.5, 2, maximanumber)

max_number_RNase_0.1 = apply(allmaxima_RNase_0.1, 2, maximanumber)
max_number_RNase_0.2 = apply(allmaxima_RNase_0.2, 2, maximanumber)
max_number_RNase_0.3 = apply(allmaxima_RNase_0.3, 2, maximanumber)
max_number_RNase_0.4 = apply(allmaxima_RNase_0.4, 2, maximanumber)
max_number_RNase_0.5 = apply(allmaxima_RNase_0.5, 2, maximanumber)

# Plotting some random protein with threshold in x-axis and number of maxima in y-axis

maxima_number_plot = function(input1, input2, input3, input4, input5, row){
  output = 0
  output[1] = input1[row]
  output[2] = input2[row]
  output[3] = input3[row]
