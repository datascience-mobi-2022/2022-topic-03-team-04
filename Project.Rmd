...
# Results
allmaxima_Ctrl = data.frame(apply(tCtrl_Norm, 2, function(x){maximafunction(x,0.5)}), row.names = fractionnames)
allmaxima_RNase = data.frame(apply(tRNase_Norm, 2, function(x){maximafunction(x,0.5)}), row.names = fractionnames )
