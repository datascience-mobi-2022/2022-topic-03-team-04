...
To find more RNA dependent proteins, we will include a 3rd criteria to classify the protein as RNA dependent. The 3rd criteria is the result of t-test of local maxima. The reason is that from 2259 Proteins that are listed in the data bank, we only identify 228 of 2259 proteins (10.09%) as RNA dependent protein with 2 conditions. With a 3rd condition, we expect more proteins to be identified as RNA dependent. 
