...
```{r}
Data.RBPResearch <- read.table("~/Desktop/2022-topic-03-team-04/table_RBP_lists.csv", header = TRUE, sep = ",", fill = TRUE)
...
Ctrl and RNase should have lower correlation for RDeep than non-RDeep
...
linear_model <- lm(y-shift ~ correlation, data =   )


cor(RNase_Dependent_Allmax_2, Ctrl_Dependent_Allmax_2)

cor(RNase_Independent_Allmax_2, Ctrl_Independent_Allmax_2)
