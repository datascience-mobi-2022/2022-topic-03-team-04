...
The plot of predicted and actual value of X shift works fairly good when the x shift are very minimal (shift by one fraction). The linear model unfortunately doesn't predict very well due to the variability of the x shift, especially when the shift is higher. 