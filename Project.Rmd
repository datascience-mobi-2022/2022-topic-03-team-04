...
Madleen: Results visualization
Richard: Coding (analysis), Report
...
After testing multiplte variables from the new data bank and the data that we have, we decide to use these 2 variables because the others have low correlation and our variables have p value that is less than 0.05 in linear regression. 
