...
databank_value = databank_adjusted[-which(databank_adjusted == 0)]
...
Too many RNA dependent proteins were not identified (1860), so we have to try to find more Maxima and more potential dependent proteins, we can apply our criteria on 
...
To find more RNA dependent proteins, we will include a 3rd criteria to classify the protein as RNA dependent. The 3rd criteria is the result of T Test of local maxima. From 2088 Proteins that are listed in the data bank, we only identify 228 of 2088 proteins as RNA dependent with 2 conditions. With a 3rd condition, we expect more proteins to be identified as RNA dependent. 
