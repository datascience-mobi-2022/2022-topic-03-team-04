...
4.3.1 K-means Clustering (Y-shift and X-shift detection):
...
We firstly defined two criteria for RNA-dependency. The k-means clustering of the Y-Shift and X-Shift and the T-Test significance. 
Although our defined two criteria could find RNA-dependent proteins with high true positive rate, the false negative rate was still too high, and even after we defined the third criteria it did not get significantly better. 
